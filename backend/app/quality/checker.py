...
def check_academic_quality(original: str, rewritten: str) -> Dict[str, Any]:
    ...
    - Missing citations
    - Missing equations
    - Numerical consistency (hallucination check)
    - Informal vocabulary warnings
    """
    warnings = []
    ...
    if missing_nums:
        # Filter out minor numbering differences that are very common, but flag specific numbers
